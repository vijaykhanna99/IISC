...
const CurriculumGrid = ({ setCurrentPage }) => {
  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="py-8 bg-gray-50 px-8">
        <div className="bg-gray-50 rounded-lg flex  space-x-24">
          <div className="flex flex-col">
            ...
            <p className="text-gray-700">
              Please select a major discipline to view detailed course
              information and semester-wise course requirements
            </p>
          </div>
          <select
            id="department-select"
            className="flex-1 px-4 py-2 border font-semibold w-96 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-600"
        ...
        {/* Description text with some fancy words */}
